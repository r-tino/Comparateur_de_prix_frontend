'use client'
import { AlarmCheck, Heart, HeartCrack, Trash2, X } from "lucide-react"; // Import the X icon for remove action
...
const SelectionPage = () => {
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen pb-20 text-center pt-20">
      ...
      <h2 className="text-2xl font-bold mt-12 mb-6 text-black">Ma sélection</h2>
            ...
            <div className="ml-4 text-left w-full">
              ...
              <div className="ml-auto flex space-x-20 mt-20">
                ...
                >
                  ...
                  <span className="text-sm">Activer l’alerte prix</span>
                </a>
                <a
                  href="#"
                  onClick={(e) => {
                ...
                >
                  ...
                  <span className="text-sm">Retirer produit</span>
                </a>
                {/* Bouton Voir produit */}
      ...
      {/* Section Favoris */}
      <h2 className="text-2xl font-bold mb-6 pt-20 text-black">Articles vus récemment</h2>
      <div className="flex space-x-6 overflow-x-auto pb-6 pt-6 justify-center mx-auto px-auto w-full max-w-4xl">
      {favorites.map((product) => (
        <Link href={`/products/${product.id}`} key={product.id} passHref>
          <div
            className="min-w-[180px] bg-white border border-gray-300 rounded-lg shadow-lg overflow-hidden transform hover:scale-105 transition duration-200"
          >
            <img
              src={product.image}
              alt={product.name}
