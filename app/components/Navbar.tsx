  ...
  return (
    <AnimatePresence>
      <motion.nav
        ...
        exit={{ opacity: 0, y: -20 }}
        className="bg-white/10 backdrop-filter backdrop-blur-lg bg-opacity-30 border-b border-gray-200 fixed top-0 left-0 right-0 z-50 transition-all duration-300 ease-in-out hover:bg-white/20"
      >
          ...
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center space-x-4">
              {isAuthenticated ? (
                <DropdownMenu>
                  ...
                  <DropdownMenuContent
                    align="end"
                    className="w-56 py-2 bg-white/80 backdrop-filter backdrop-blur-lg rounded-md shadow-lg"
                  >
                    ...
                    <DropdownMenuItem asChild>
                      <Link
                        href="/selection"
                        className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-blue-100 transition-colors duration-200"
                      >
            ...
            <div className="flex md:hidden">
              <Sheet>
                ...
                <SheetContent
                  side="right"
                  className="w-[300px] sm:w-[400px] bg-white/80 backdrop-filter backdrop-blur-lg"
                >
